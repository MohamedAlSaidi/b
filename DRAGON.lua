...
if tonumber(user_id) == tonumber(1993823358) then  
var = true 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹V A M P I  R ˼', url="t.me/XxlllllllllllllllllllllllllllxX"},{text = '˹S E Z E R˼', url="t.me/s_e_z_r0"}},
{{text = '˹B o g y˼', url="t.me/BOT3Dark"}}, 
...
if text == '𝐕𝘼𝙈𝘽𝙄𝙍' or text == 'فمبير' or text == 'المبرمج بوجي' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 1993823358,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'المبرمج 🌚💘\n['..result.first_name_..'](t.me/BOT3Dark)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/BOT3Dark"},
},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1993823358, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
if text == 'استوري بوجي' or text == 'كوكب بوجي' or text == 'قناه المبرمج بوجي' or text == 'متيجي' or text == 'متيقي' then
local Text = [[
متيقي هنا دي بقي الكوكب الخاص بالمبرمج بوجي
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑷𝑳𝑨𝑵𝑬𝑻 Bogy🏂💖',url="t.me/DARKBOGY"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(msg.sender_user_id_) == tonumber(1993823358) then
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[رتبتك المبرمج بوجي🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[بنت المبرمج بوجي🥺💘](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
keyboard.inline_keyboard = {
{{text = '˹ B o g y ˼',url="t.me/BOT3Dark"}},
{{text = '˹ T A W O S L ˼ ',url="t.me/DARKBOGY"}}, 
{{text = ' ˹B A C K ˼', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
